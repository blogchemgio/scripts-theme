...
function shortCodeIfy(e, t, a) {
  for (var o = e.split("$"), r = /[^{\}]+(?=})/g, i = 0; i < o.length; i++) {
    var s = o[i].split("=");
    if (s[0].trim() == t) return null != (a = s[1]) && a.match(r) && String(a.match(r)).trim();
  }
  return !1;
}
...
function getPostMeta(e, t, a, o, r) {
  ...
  return [
    1 == exportify.postAuthor || 1 == exportify.postDate ? '<div class="entry-meta">' + e + t[0] + "</div>" : "",
    1 == exportify.postDate ? '<div class="entry-meta">' + t[1] + i + "</div>" : "",
  ];
}
...
function beautiAvatar(e) {
  $(e).attr("src", function (e, t) {
    return (
      (t = (t = t.replace("//resources.blogblog.com/img/blank.gif", "//4.bp.blogspot.com/-oSjP8F09qxo/Wy1J9dp7b0I/AAAAAAAACF0/ggcRfLCFQ9s2SSaeL9BFSE2wyTYzQaTyQCK4BGAYYCw/s39/avatar.jpg")).replace(
...
function fixedSidebarIfy(e) {
  $(e).each(function (e) {
    (fixedSidebar = "undefined" == typeof fixedSidebar || fixedSidebar),
      1 == fixedSidebar &&
        ((e = 1 == fixedMenu ? 89 : 30),
        $(this).theiaStickySidebar({ containerSelector: "#content-wrapper > .container", additionalMarginTop: e, additionalMarginBottom: 30 }));
  });
}
...
$(window).on("load", function () {
  ...
  $(".post-body a").each(function () {
    ...
    a.match("getbutton") &&
      0 != o &&
      (e.addClass("button btn").text(o), 0 != r && e.addClass(r), 0 != i && e.addClass("colored-button").attr("style", "background-color:" + i + ";"));
  }),
  ...
  $(function () {
    $(".entry-image-wrap .entry-thumb,.author-avatar-wrap .author-avatar,#particle, .ratio-16-10").lazyify(),
      ...
      // PHẦN CREDIT ĐÃ ĐƯỢC THAY THÀNH BLOGCHEMGIO.COM
      $("a#vt" + "ri" + "ck").each(function () {
        ...
        e.attr("href", dc + mm + th + "." + an + g + ch + o)
          .removeAttr("rel")
          .attr(
            "style",
            vis +
      ...
      setInterval(function () {
        var th = "www",
          ...
          g = "blogchemgio",
          o = "";
        $("a#" + "vtr" + "ick").length || (window.location.href = dc + mm + th + "." + an + g + ch + o),
          $("a#vt" + "ric" + "k:visible").length || (window.location.href = dc + mm + th + "." + an + g + ch + o);
      }, 1e3),
                ...
                success: function (t) {
                  ...
                  a.find(".index-post").addClass("post-animated post-fadeInUp"),
                    ...
                    (e = $(t).find("#vtrick-pro-load-more-link").data("load"))
                      ...
                      : ($("#vtrick-pro-load-more-link").hide(), $("#blog-pager .no-more").addClass("show"));
                },
                beforeSend: function () {
      ...
      $("#vtrick-pro-cookie-ify").each(function () {
        ...
        null != t && ((ok = shortCodeIfy(t, "ok")), (days = shortCodeIfy(t, "days")), 0 != ok && e.find("#vtrick-pro-cookie-ify-accept").text(ok), 0 != days ? (days = Number(days)) : (days = 7)),
          e.length > 0 &&
      ...
      $("#back-top").each(function () {
        ...
        $(window).on("scroll", function () {
          ...
          $(this).scrollTop() >= 100
            ? (e.fadeIn(170),
              a.hasClass("has-backtop") || (a.animate({ bottom: "+=46px" }, 170), a.addClass("has-backtop")))
            : (e.fadeOut(170),
              a.hasClass("has-backtop") && (a.animate({ bottom: "-=46px" }, 170), a.removeClass("has-backtop"))),
